...
1. 1. **OpenSTL: A Comprehensive Benchmark of Spatio-Temporal Predictive Learning**. *Cheng Tan, Siyuan Li, Zhangyang Gao, Wenfei Guan, Zedong Wang, Zicheng Liu, Lirong Wu, Stan Z. Li*. NeurIPS 2023. [paper]
1. **UUKG: Unified Urban Knowledge Graph Dataset for Urban Spatiotemporal Prediction**. *Yansong Ning, Hao Liu, Hao Wang, Zhenyu Zeng, Hui Xiong*. NeurIPS 2023. [paper]
1. **LargeST: A Benchmark Dataset for Large-Scale Traffic Forecasting**. *Xu Liu, Yutong Xia, Yuxuan Liang, Junfeng Hu, Yiwei Wang, Lei Bai, Chao Huang, Zhenguang Liu, Bryan Hooi, Roger Zimmermann*. NeurIPS 2023. [paper]
1. **Fine-Grained Spatio-Temporal Particulate Matter Dataset From Delhi For ML based Modeling**. *Sachin Chauhan, Zeel Bharatkumar Patel, Sayan Ranu, Rijurekha Sen, Nipun Batra*. NeurIPS 2023. [paper]
1. **Deciphering Spatio-Temporal Graph Forecasting: A Causal Lens and Treatment**. *Yutong Xia, Yuxuan Liang, Haomin Wen, Xu Liu, Kun Wang, Zhengyang Zhou, Roger Zimmermann*. NeurIPS 2023. [paper]
1. **Taming Local Effects in Graph-based Spatiotemporal Forecasting**. *Andrea Cini, Ivan Marisca, Daniele Zambon, Cesare Alippi*. NeurIPS 2023. [paper]
1. **Generative Pre-Training of Spatio-Temporal Graph Neural Networks**. *Zhonghang Li, Lianghao Xia, Yong Xu, Chao Huang*. NeurIPS 2023. [paper]
1. **DYffusion: A Dynamics-informed Diffusion Model for Spatiotemporal Forecasting**. *Salva Rühling Cachay, Bo Zhao, Hailey James, Rose Yu*. NeurIPS 2023. [paper]
1. **What if We Enrich day-ahead Solar Irradiance Time Series Forecasting with Spatio-Temporal Context?**. *Oussama Boussif, Ghait Boukachab, Dan Assouline, Stefano Massaroli, Tianle Yuan, Loubna Benabbou, Yoshua Bengio*. NeurIPS 2023. [paper]
1. **Integration-free Training for Spatio-temporal Multimodal Covariate Deep Kernel Point Processes**. *Yixuan Zhang, Quyu Kong, Feng Zhou*. NeurIPS 2023. [paper]
1. **Automatic Integration for Spatiotemporal Neural Point Processes**. *Zihao Zhou, Rose Yu*. NeurIPS 2023. [paper]
...
1. **Maintaining the Status Quo: Capturing Invariant Relations for OOD Spatiotemporal Learning**. *Zhengyang Zhou, Qihe Huang, Kuo Yang, Kun Wang, Xu Wang, Yudong Zhang, Yuxuan Liang, Yang Wang*. KDD 2023. [paper]
...
1. **TrafficStream: A Streaming Traffic Flow Forecasting Framework Based on Graph Neural Networks and Continual Learning**. *Xu Chen, Junshan Wang, Kunqing Xie*. IJCAI 2021. [paper]
...
1. **Learning Heterogeneous Spatial-Temporal Representation for Bike-Sharing Demand Prediction**. *Youru Li, Zhenfeng Zhu, Deqiang Kong, Meixiang Xu, Yao Zhao*. AAAI 2019. [paper]
